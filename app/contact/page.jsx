...
function ContactPage() {
  ...
  const avatar = data?.imageUrl || "/images/avatar.png";
  ...
  const avatarImage =(
    <Image
      ...
      height={180}
      src={avatar}
      className="rounded-full shadow-sm border-2 border-[#FFE100]"
      priority
    />
  );
        ...
        <div className="flex flex-row gap-4">
          ...
          <div>
            <Image
              ...
              height={120}
              alt="ie-logo"
              src="/images/Mi_tarjeta_digital.png"
            />
          </div>
        </div>
